...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public static String mTitle = AppConstant.MEDITATE;

    // Default type of operation
    public static int mType = MEDITATE;
    ...
    protected Toolbar activateToolbar() {
        if (mToolBar == null) {
            ...
            if (mToolBar != null) {
                ...
                switch (mType) {
                    case REMINDERS:
                        getSupportActionBar().setTitle(AppConstant.MEDITATE);
                        break;
                    */
/*case NOTES:
...
//                        mNextActivity = NotesActivity.class;
                        mNextActivity = MeditationPlayer.class;
                        actAsNote();
                        break;
                    case 1:
//                        mNextActivity = NotesActivity.class;
